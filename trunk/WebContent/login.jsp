...
<SCRIPT LANGUAGE="JavaScript">
      function showCalendar(month, year) {// показать календать
        ...
        function selectDate() {
            ...
            if (normalYear(year)) {
                var month = getMonth(document.Reservation.radioGroup);
        ...
        function showCurrentMonth() {//показать текущий месяц
            ...
            if (year < 2000)
                year = year + 1900;
            this.focusDay = day;
            setMonth(document.Reservation.radioGroup,month);
        ...
        function setMonth(radioGroup,i)
        {
			...
			<form action="Controller" method="POST" name="Reservation">
				...
				<table align="center" border="1" cellspacing="2" cellpadding="2">
					<tbody>
                                                            ...
                                                            <div id="blockCalendar">                                                                
                                                                <table align="center">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <br><input type="radio" name="radioGroup" onClick="selectDate()" />Январь
                                                                                <br><input type="radio" name="radioGroup" onClick="selectDate()" />Февраль
                                                                                <br><input type="radio" name="radioGroup" onClick="selectDate()" />Март
                                                                                <br><input type="radio" name="radioGroup" onClick="selectDate()" />Апрель
                                                                                <br><input type="radio" name="radioGroup" onClick="selectDate()" />Май
                                                                                <br><input type="radio" name="radioGroup" onClick="selectDate()" />Июнь
                                                                                <br><input type="radio" name="radioGroup" onClick="selectDate()" />Июль
                                                                                <br><input type="radio" name="radioGroup" onClick="selectDate()" />Август
                                                                                <br><input type="radio" name="radioGroup" onClick="selectDate()" />Сентябрь
                                                                                <br><input type="radio" name="radioGroup" onClick="selectDate()" />Октябрь
                                                                                <br><input type="radio" name="radioGroup" onClick="selectDate()" />Ноябрь
                                                                                <br><input type="radio" name="radioGroup" onClick="selectDate()" />Декабрь
                                                                            </td>
						...
						<tr>                                                    
                                                    <td>Начало:<br> <input type="text" name="Begin" value="" /><br>
                                                        Окончание:<br> <input type="text" name="End" value="" /><br></td>

                                                <td>Расписание<br></td>
                                                </tr>
						<tr colspan="2">                                                    
							<td colspan="2"><input type="submit" class="buttonHorisontal" value="Зарезервировать" />
							<td>                                                            
						</tr>
					</tbody>
				</table>
