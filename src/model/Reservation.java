...
@Entity
@NamedQueries({
@NamedQuery(name = "Get_Reservations_Count", 
...
@NamedQuery(name = "Count_Reservation_in_Time",
    ...
    + "or end_time "
    + "between ? and ?)")})
@SqlResultSetMapping(name = "Reservation",
    entities =@EntityResult(entityClass = Reservation.class))
@NamedNativeQueries({
...
public class Reservation implements Serializable
    ...
    public Reservation(Resource resource, Date start_time, Date end_time, Client client) {
